...
//v1.1.85 í«â¡
#define LAKE_T_ACID			8
#define LAKE_T_ACID_VAULT	9
#define LAKE_T_POIS			10
#define LAKE_T_POIS_VAULT	11
#define LAKE_T_COLD			12
#define LAKE_T_COLD_VAULT	13
#define LAKE_T_ELEC			14
#define LAKE_T_ELEC_VAULT	15
#define LAKE_T_MAX			15 //ç≈ëÂÇÃílÇ∆ìØÇ∂Ç…Ç∑ÇÈÇ±Ç∆
