...
static unique_player_type unique_player_table[UNIQUE_PLAYER_NUM] =
{
	...
	{ TRUE,"ユイマン・浅間",CLASS_YUIMAN,RACE_DEITY,ENTRY_KINJYOU,SEX_FEMALE,
		"あなたは神の世界の端にある維縵国の王女でした。月の民によって迷宮に囚われ長い間働かされていましたが外の異変と巫女らの活躍により外に出られるようになりました。戦闘においては弓の扱いが得意で、弓がなくても矢を直接投擲して戦うことができます。また魔法を一領域巧みに扱うことができ、さらに体に巻き付いた蛇の能力で装備品の呪いを解いたり敵から魔力を奪ったりすることができます。ダンジョン「浅間浄穢山」はあなたにとって自宅も同然で、そこでは高い感知力と一部の特殊モンスターに対する高い制圧力を行使することが可能です。" },
	//その他からこっちに持って来た
	...
	{ TRUE,"磐永　阿梨夜",CLASS_ARIYA,RACE_DEITY,ENTRY_KINJYOU,SEX_FEMALE,
		"あなたは不変の力をもつ石の女神です。その力は自分の体だけにとどまらずその気になれば幻想郷全域に及びます。あなたは非常に高い体力をもち、さらに自分への様々な攻撃を軽減あるいは無効化し、その上敵に対して凶悪な妨害を押し付け、また魔法を二領域巧みに扱うことができます。よほど油断をしない限り戦いで遅れを取ることはほぼないでしょう。ただしあらゆる変化を拒絶するあなたは成長が非常に遅くレベルアップに多くの経験値が必要です。また変身などの一部の補助魔法も効果を発揮しません。" },
	{ TRUE,"渡里　ニナ",CLASS_NINA,RACE_YOUKAI,ENTRY_KINJYOU,SEX_FEMALE,
		"あなたは蜃気楼を作り出す貝の妖怪です。あなたの本体は非常に古い貝の化石ですが自意識の上ではまだ生まれたばかりのため見聞きしたものにすぐ影響を受けてしまうようです。蜃気楼の力を使ってダンジョン内に建物を作ったり敵の使った特技をものまねして攻撃する特技を持っています。また魔法を一領域習得することができます。ものまねによる攻撃は非常に強力ですが配下を活用した独特の立ち回りが必要になります。あなたは防御力に優れるものの肉弾戦は全くの不得手なので、強い配下が手に入りにくい序盤では魔法をうまく活用しましょう。" },
