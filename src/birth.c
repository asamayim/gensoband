...
"あなたは魔法の装飾品を扱う宝石細工師です。宝石や装飾品から魔力を抽出し、他の装飾品に特別な宝飾を施すことで魔力を付与する技術を持っています。作業は街の宝飾ギルドで行います。あなたは手先が器用で魔法の道具の扱いに優れますが、近接戦闘能力は一般人と変わりません。魔法を一領域習得可能ですが純魔法職に比べるとやや素質に劣ります。修得する魔法領域は慎重に選択する必要があるでしょう。レベルが上がると手持ちの宝石から魔力を吸収してMPを回復する特技を習得します。",
...
static unique_player_type unique_player_table[UNIQUE_PLAYER_NUM] =
{
	...
	{ FALSE,"奥野田　美宵",CLASS_MIYOI,RACE_YOUKAI,ENTRY_OTHER,SEX_FEMALE,
		"(未実装)" },
